...
module ChatConvert
  ...
  RANDOM_CONVERSION_TABLE = { # {{{
    /^thx$/ => [
      ...
      'お互いに胸筋を開いて語り合う貴重な時間を下さった、今回の粋なお取り計らいに心から感謝申し上げます',
    ...
    /^yw|いえいえ$/ => [
      ...
      'いえいえ、こちらこそこれもひとえに皆々様のご支援・ご協力あってのことと心より感謝しております'],
    /^fmfm$/ => [
      'ふむふむ',
      'ふむふむ、ナルホディウスですぞ〜',
      '_φ(′￢｀｡φ(-ω-｡;φ(′￢｀｡φ(-ω-｡;)ﾌﾑﾌﾑ.',
      'ﾌﾑﾌﾑ... φ(￥◆\'`｡)φ　...ﾁｪｯｸ',
      '___φ(ﾟｰﾟ*)ﾌﾑﾌﾑ___φ(｡_｡*)ｶｷｶｷ ΣΣﾋﾞﾘｯ!!___ φ(ﾟдﾟ｀)'],
    /すごい/ => [
      'すごい (かなり)',
      'すごい (あきらかに)',
      'すごい (かくじつに)',
